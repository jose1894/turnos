<div>
  <!-- Modal -->
  <div wire:ignore.self class="modal fade" id="createRoleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                                        ...
                                        $permissions .= '
                                            <div class="form-check">
                                                <label class="flex-fill">
                                                    <input type="checkbox" id="permission-'.$value->id.'" wire:model="selectedPermissions.'.$value->id.'" class="form-check-input">
                                                    '.$value->name.'
                                                </label>
                                            </div>';
                                    }
              ...
              <div class="modal-footer">
                  ...
                  <button type="button" wire:click.prevent="storeRole()" class="btn btn-primary close-modal">Guardar</button>
              </div>
          </div>
      </div>
  </div>

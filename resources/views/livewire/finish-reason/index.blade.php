<div class="container-fluid">
    <div class="row">
        <div class="col-12 my-4">
            <div class="float-right">
                <button type="button" class="btn btn-success" data-toggle="modal" wire:click="resetInputFields()" data-target="#createFinishReasonModal">
    ...
    @include('livewire.finish-reason.create')

    @include('livewire.finish-reason.update')
                        ...
                        <table class="table table-stripped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button data-toggle="modal" data-target="#updateFinishReasonModal" wire:click="edit({{ $reason->id }})" class="btn btn-primary btn-sm">

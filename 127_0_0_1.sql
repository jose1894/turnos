...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Sep 14, 2023 at 08:47 PM
...
--
-- Table structure for table `finish_reasons`
--
...
--
-- Dumping data for table `finish_reasons`
--
...
CREATE TABLE IF NOT EXISTS `offices` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` enum('1','2') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Defines office type: 1 => control, 2 => juridico',
  `status` int NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `offices` (`id`, `name`, `type`, `status`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'Control-1', '1', 1, NULL, NULL, NULL),
(2, 'Control-2', '1', 1, NULL, NULL, NULL),
(3, 'Control-3', '1', 1, NULL, NULL, NULL),
(4, 'Control-4', '1', 1, NULL, NULL, NULL),
(5, 'Control-5', '1', 1, NULL, NULL, NULL),
(6, 'Control-6', '1', 1, NULL, NULL, NULL),
(7, 'Control-7', '1', 1, NULL, NULL, NULL),
(8, 'Control-8', '1', 1, NULL, NULL, NULL),
(9, 'Control-9', '1', 1, NULL, NULL, NULL),
(10, 'Control-10', '1', 1, NULL, NULL, NULL),
(11, 'Control-11', '1', 1, NULL, NULL, NULL),
(12, 'TPM-3', '1', 1, NULL, '2023-09-14 15:00:44', NULL),
(13, 'TPM-5', '1', 1, NULL, '2023-09-14 15:00:58', NULL),
(14, 'Juicio-4', '1', 1, '2023-09-14 13:31:04', '2023-09-14 13:31:04', NULL);
...
INSERT INTO `people` (`id`, `name`, `lastname`, `gender`, `people_type`, `id_card`, `address`, `status`, `deleted_at`, `created_at`, `updated_at`) VALUES
(1, 'PEDRO', 'PEREZ', 'M', 'INPRE', '123456789', '6666', 1, NULL, '2023-09-04 22:10:12', '2023-09-04 22:10:12'),
(2, 'Maria', 'Peña', 'F', 'INPRE', '123456666', 'edfgdf', 1, NULL, '2023-09-04 22:34:08', '2023-09-04 22:34:08'),
(3, 'Mariano', 'Rivera', 'M', 'INPRE', '11111111', 'aaa', 1, NULL, '2023-09-04 22:40:57', '2023-09-04 22:40:57'),
(4, 'Curt', 'Schilling', 'M', 'INPRE', '22222', '2222', 1, NULL, '2023-09-04 22:41:29', '2023-09-04 22:41:29'),
(5, 'Pedro', 'Martinez', 'M', 'INPRE', '333333', 'dddd', 1, NULL, '2023-09-04 22:42:02', '2023-09-04 22:42:02'),
(6, 'Pedro', 'Marquez', 'M', 'INPRE', '1111', 'fgvgfgg', 1, NULL, '2023-09-04 22:54:04', '2023-09-04 22:54:04'),
(7, 'Sebastian', 'Rojas', 'M', 'INPRE', '3333333', 'asdasd', 1, NULL, '2023-09-05 14:02:06', '2023-09-05 14:02:06'),
(8, 'Maria', 'Bermudez', 'F', 'INPRE', '44444', 'ddfg', 1, NULL, '2023-09-05 14:02:43', '2023-09-05 14:02:43'),
(9, 'Paola', 'Manrique', 'F', 'INPRE', '999999', 'dfgdfg', 1, NULL, '2023-09-05 14:03:21', '2023-09-05 14:03:21'),
(10, 'Teresa', 'Muñoz', 'F', 'INPRE', '666666', 'fghfgh', 1, NULL, '2023-09-05 14:03:47', '2023-09-05 14:03:47'),
(11, 'Vanessa', 'Millan', 'F', 'INPRE', '5555555', 'ggg', 1, NULL, '2023-09-05 14:04:31', '2023-09-05 14:04:31'),
(12, 'Briseida', 'Hernandez', 'F', 'INPRE', '00000', 'gggg', 1, NULL, '2023-09-05 14:05:08', '2023-09-05 14:05:08'),
(13, 'CARLOS', 'GUANCHEZ', 'M', 'INPRE', '20232023', 'GGG', 1, NULL, '2023-09-05 19:16:02', '2023-09-05 19:16:02'),
(14, 'JULIO', 'PADRON', 'M', 'INPRE', '20292029', 'FF', 1, NULL, '2023-09-05 19:16:38', '2023-09-05 19:16:38'),
(15, 'HINGRID', 'PANTOJA', 'F', 'INPRE', '301671', 'VALENCIA', 1, NULL, '2023-09-11 14:44:34', '2023-09-11 14:44:34'),
(16, 'ESTEBAN ', 'JEREZ', 'M', 'INPRE', '231904', 'GUIGUE, MUNICIPIO CARLOS ARVELO ', 1, NULL, '2023-09-11 14:46:28', '2023-09-11 14:46:28'),
(17, 'JOSE', 'GUERRA', 'M', 'V', '17031766', 'MUNICIPIO VALENCIA', 1, NULL, '2023-09-11 15:01:33', '2023-09-11 15:01:33'),
(18, 'LUIS ', 'RANGEL', 'M', 'INPRE', '250461', 'MUNICIPIO CARLOS ARVELO', 1, NULL, '2023-09-11 15:04:48', '2023-09-11 15:04:48');
...
CREATE TABLE IF NOT EXISTS `tickets` (
  ...
  `record` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('a','b','c','i') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'a' COMMENT 'a: Sin atenter,b: Atendiendo, c: Atendido, i: Anulado',
...
INSERT INTO `tickets` (`id`, `ticket`, `people_id`, `office_id`, `reason_id`, `finish_reason_id`, `user_id`, `record`, `status`, `comments`, `attended`, `finished`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'Control-5-1', 1, 5, 2, 3, 1, '12354', 'c', '', NULL, '2023-09-04 18:39:15', '2023-09-04 22:10:30', '2023-09-04 22:39:15', NULL),
(2, 'Control-5-2', 2, 5, 2, 1, 1, 'ssss', 'c', '', NULL, '2023-09-04 18:42:33', '2023-09-04 22:34:21', '2023-09-04 22:42:33', NULL),
(3, 'Control-1-1', 3, 1, 1, 3, 1, '11111', 'c', '', NULL, '2023-09-04 18:56:26', '2023-09-04 22:41:08', '2023-09-04 22:56:26', NULL),
(4, 'Control-1-2', 4, 1, 2, 1, 1, '22222', 'c', '', NULL, '2023-09-05 10:07:58', '2023-09-04 22:41:43', '2023-09-05 14:07:58', NULL),
(5, 'Control-1-3', 5, 3, 4, 3, 1, 'gfffgf', 'c', '', NULL, '2023-09-04 18:55:22', '2023-09-04 22:42:16', '2023-09-04 22:55:22', NULL),
(6, 'Control-5-3', 6, 5, 2, NULL, 1, '66666', 'a', 'gggg', NULL, NULL, '2023-09-04 22:54:18', '2023-09-05 14:08:23', '2023-09-05 14:08:23'),
(7, 'Control-1-1', 1, 1, 2, NULL, 1, 'sssss', 'b', '', NULL, NULL, '2023-09-05 14:17:35', '2023-09-05 14:55:43', NULL),
(8, 'Control-2-1', 2, 2, 2, NULL, 1, 'ssss', 'b', '', NULL, NULL, '2023-09-05 14:19:56', '2023-09-05 14:59:38', NULL),
(9, 'Control-3-1', 3, 3, 2, NULL, 1, 'ssss', 'b', '', NULL, NULL, '2023-09-05 14:22:55', '2023-09-05 15:03:02', NULL),
(10, 'Control-4-1', 4, 4, 2, 3, 1, 'ssss', 'c', '', NULL, '2023-09-14 10:08:29', '2023-09-05 14:23:13', '2023-09-14 14:08:29', NULL),
(11, 'Control-5-1', 5, 5, 2, 1, 1, 'ssss', 'c', 'ss', NULL, '2023-09-05 15:29:26', '2023-09-05 14:23:41', '2023-09-05 19:29:26', NULL),
(12, 'Control-6-1', 6, 6, 2, 1, 1, 'ssss', 'c', 's', NULL, '2023-09-14 16:10:31', '2023-09-05 14:26:01', '2023-09-14 20:10:31', NULL),
(13, 'Control-7-1', 7, 7, 2, 1, 1, 'SSSSSSSSSSSS', 'c', 'SSSSSSSS', NULL, '2023-09-14 10:39:36', '2023-09-05 14:38:51', '2023-09-14 14:39:36', NULL),
(14, 'Control-8-1', 8, 8, 4, NULL, 1, 'RRRRRRRRRR', 'b', '', NULL, NULL, '2023-09-05 14:39:21', '2023-09-05 15:07:40', NULL),
(15, 'Control-9-1', 9, 9, 2, 1, 1, 'ssssss', 'c', '', NULL, '2023-09-14 11:22:01', '2023-09-05 14:49:04', '2023-09-14 15:22:01', NULL),
(16, 'Control-10-1', 10, 10, 2, 1, 1, 'sssss', 'c', '', NULL, '2023-09-14 11:50:12', '2023-09-05 14:49:26', '2023-09-14 15:50:12', NULL),
(17, 'Control-11-1', 11, 11, 2, NULL, 1, 'ssss', 'b', 'sss', NULL, NULL, '2023-09-05 14:49:46', '2023-09-05 15:15:08', NULL),
(18, 'TPM-1-1', 12, 12, 2, 1, 1, 'ooooooooo', 'c', '', NULL, '2023-09-14 10:55:05', '2023-09-05 14:50:10', '2023-09-14 14:55:05', NULL),
(19, 'TPM-1-2', 4, 12, 2, NULL, 1, '33333', 'a', '', NULL, NULL, '2023-09-05 18:51:33', '2023-09-05 18:51:33', NULL),
(20, 'Control-1-2', 7, 1, 1, NULL, 1, '321654321', 'a', 'UNA OBSERVACION', NULL, NULL, '2023-09-05 19:00:18', '2023-09-05 19:00:18', NULL),
(21, 'Control-5-2', 13, 5, 4, 1, 1, '654KJHG-5', 'c', 'CAUSA DE MARACAY', NULL, '2023-09-12 09:45:59', '2023-09-05 19:22:18', '2023-09-12 13:45:59', NULL),
(22, 'Control-1-1', 15, 1, 1, NULL, 5, 'CI-2023-12340', 'a', 'PROCEDIMIENTO DE GUARDIA', NULL, NULL, '2023-09-11 14:50:01', '2023-09-11 14:50:01', NULL),
(23, 'Control-4-1', 17, 4, 4, NULL, 9, 'CI-2023-123456', 'a', 'ENTREGA DE MATERIALES', NULL, NULL, '2023-09-11 15:03:02', '2023-09-11 15:03:02', NULL),
(24, 'Control-4-2', 18, 4, 2, NULL, 9, 'CI-2023-455678', 'a', '', NULL, NULL, '2023-09-11 15:05:09', '2023-09-11 15:05:09', NULL);
...
(4, 'Karen', 'Cardenas', 'karen.cardenas@turnos.local', NULL, '$2y$10$qcWg7dnU2wlUDqQrvlH2w.EK9uLig96FUsuwbZEwccaENEzeS9vgq', 5, NULL, '2023-09-04 19:57:16', '2023-09-12 13:36:52', NULL),
